...
import objektstrukturer.Tweet;
import objektstrukturer.TwitterAccount;
...
public class TweetTest extends TestCase {
  ...
  private void _test__constructorRetweet_transitions0_effect_state_objectTests0_test(final Tweet it) {
    ...
    TwitterAccount _owner = it.getOwner();
    assertEquals("owner == ole failed after retweet1 = new Tweet(ole, tweet)", this.ole, _owner); //her har jeg nils(skal være ole i testen)
